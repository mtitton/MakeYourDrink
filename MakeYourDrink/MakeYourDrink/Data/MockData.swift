...
enum MockData {
    static let ingredients: [Ingredient] = [
        ...
        Ingredient(name: "Licor Maraschino", category: .liqueurs, isAlcoholic: true),
        ...
        Ingredient(name: "Stout", category: .beers, isAlcoholic: true),
        ...
        Ingredient(name: "Cereja", category: .garnishes),
